...
- **In-memory computing with resistive switching devices** — Ielmini & Wong (2018), *Nature Electronics* 1:333–343 (Review). The RRAM-specific companion to [[wiki/refs/sebastian-2020-in-memory-computing]]. ^[author]
- ## Abstract (extracted)
...
- ## Key ideas ^[inferred]
	...
	- Names the **required scaling characteristics** (endurance / retention / variability trade-offs) as the central challenge for delivering next-generation in-memory computing. ^[inferred]
- ## Connections to Wiki
