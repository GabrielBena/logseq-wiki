...
- **Neuromorphic computing at scale** — Kudithipudi et al. (2025), *Nature* 637:801–812 (Review). A **23-author community roadmap** incl. **M. Payvand** (INI Zürich), **S. Furber** (SpiNNaker), **H. Gonzalez** (SpiNNcloud), **C. Mayr** (SpiNNaker2). The field's own statement of where neuromorphic computing is, what's missing to scale it, and which biological principles to draw on. **Full-ingested 2026-07-01 from the PDF.** ^[author]
- ## What it is
...
- ## Alignment with self-organising-hardware approaches
