...
- ## Theoretical Framing — Memory Beyond Synapses
	...
	- **"Genome instantiates a generative model"** (Mitchell & Cheney 2024; Hartl & Levin 2024 — same Levin lab as [[wiki/refs/pio-lopez-2026-brainca|BraiNCA]]): the gene encoding is a *compact generative latent* that the GeneCA decodes into morphology. EngramNCA operationalises this view in NCA form. ^[addressed]
