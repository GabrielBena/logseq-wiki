...
pmid:: 38167293
citation-count:: 61
summary:: The Mosaic neuromorphic chip — memristive Neuron Tiles (in-memory compute) + Routing Tiles (in-memory routing) implementing small-world SNN topologies in 130nm CMOS; ≥1 order-of-magnitude routing-energy savings. The host's substrate.
confidence:: 0.60
lifecycle:: draft
...
- **Mosaic: in-memory computing and routing for small-world spike-based neuromorphic systems** — Dalgaty, Moro, Demirağ, De Pra, Indiveri, Vianello, **Payvand** (2024), *Nature Communications* 15 (DOI 10.1038/s41467-023-44365-x). **The host's own substrate** — the target of [[wiki/deliverables/eth-fellowship-2026]] / [[wiki/projects/self-organising-mosaic-compiler]] (Mosaic-v2 co-design). *Upgraded from stub → draft with the verified citation, 2026-07-02.* ^[author]
- ## Abstract (extracted)
...
- ## Key ideas ^[inferred]
	...
	- **Reliability nuance (load-bearing for our bid):** Mosaic treats RRAM variability / drift / read-noise as a **non-ideality to *mitigate*** (noise-injection + quantization-aware training, ~2–3% loss) — **not** a resource to exploit. So cite Mosaic for the *substrate / routing* story, **not** for "variability-as-a-feature" (that framing belongs to [[wiki/refs/payvand-2022-memsorn]]). *(Fleet-verified, `wiki/_pdfs/eth-litreview-2026-06-26/host-facts.md`.)* ^[inferred]
- ## Connections to Wiki
	- [[wiki/deliverables/eth-fellowship-2026]] · [[wiki/projects/self-organising-mosaic-compiler]] — the host substrate + the Mosaic-v2 co-design target.
...
- ## Cited By (in this wiki)
	- [[wiki/research/spatial-neuromorphic-priors]] · [[wiki/deliverables/eth-fellowship-2026]] · [[wiki/projects/self-organising-mosaic-compiler]]
