...
- ## Key Ideas
	...
	- **Workspace as bandwidth-limited shared channel.** Specialist modules write into a small, shared latent; capacity is the key constraint. ^[inferred]
...
- ## Connections to Wiki
	...
	- [[wiki/concepts/modularity]] — the claim that capacity limits drive specialisation provides a *functional* argument for emergent modularity (consistent with the thesis-side modularity-by-pressure framing).
